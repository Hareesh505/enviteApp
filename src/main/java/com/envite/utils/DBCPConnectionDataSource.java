...
public class DBCPConnectionDataSource extends org.apache.tomcat.jdbc.pool.DataSource{
    ...
    private static final String URL = "jdbc:mysql://ex-std-node839.prod.rhcloud.com:3306/envite?user=adminHF3HitN&password=bhWDcIIxajAQ&useUnicode=true&characterEncoding=utf-8";
